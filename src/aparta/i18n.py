...
CATALOG: dict[str, dict[str, str]] = {
    "pt": {
        ...
        "Give this profile its own gcloud config? Recommended: credentials and application default credentials stay separate, so SDKs, Terraform and your agents follow the profile too": "Dar a este perfil um gcloud só dele? Recomendado: as credenciais e o application default credentials ficam separados, então os SDKs, o Terraform e os seus agentes também seguem o perfil",
